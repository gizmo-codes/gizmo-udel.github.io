...
// Close operations for the alert box
    ...
    submit.addEventListener("click", (e) => {
        ...
        */
        ...
        if (emailCheck(user_email) == false) {
            ...
            // Needed to redisplay the alert if the user closes it
            document.getElementById("alert").attributeStyleMap.clear();

            document.getElementById("alertmessage").innerHTML = "You have entered an invalid email address.\nFormat example: xyz@domain.com";
        ...
        if (phoneCheck(user_phone.value) == false) {
            ...
            document.getElementById("alertmessage").innerHTML = "Please use the following format: 123-456-7890";
            document.getElementById("alert").style.display = null;
            return false;
        }
        ...
        // If all of the above pass, call the sendMail function and close the modal.
            ...
            modal.style.display = "none";
            document.getElementById("alertsuccess").style.display = null;
        }
    })
}
validate();
